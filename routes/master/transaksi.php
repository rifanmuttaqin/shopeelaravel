...
$router->group(['prefix' => ''], function () use ($router) {
	...
	$router->get('/transaksi-show/{id}', ['as'=>'transaksi-show-page','uses' => 'TransaksiController@show']);
	...
	$router->post('/destroy',  ['as'=>'transaksi-destroy','uses' => 'TransaksiController@destroy']);
