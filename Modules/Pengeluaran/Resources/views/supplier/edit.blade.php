...
<div class="col-lg-12 col-md-12 col-12 col-sm-12">
      ...
      <div class="card-body">
            ...
            <form  method="post" action="{{route('supplier-update')}}" enctype="multipart/form-data">
                  ...
                  <input type="hidden" value="{{ $data_supplier->id}}" name="id">
                  
                  <div class="form-group">
                        <label>Nama</label>
                        <input type="text" value="{{ $data_supplier->nama }}" class="form-control form-control-user" name ="nama" id="nama" placeholder="">
                  ...
                  <div class="form-group">
                        <label>Kontak</label>
                        <input type="text" value="{{ $data_supplier->kontak }}" class="form-control form-control-user" name ="kontak" id="kontak" placeholder="">
                  ...
                  <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" value="{{ $data_supplier->alamat }}" class="form-control form-control-user" name ="alamat" id="alamat" placeholder="">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" value="{{ $data_supplier->keterangan }}" name ="keterangan" id="keterangan" placeholder="">
                  ...
                  <select name="status_aktif" class="form-control">
                        ...
                        <option value="0" @if($data_supplier->status_aktif == 0) {{ 'selected' }} @endif>Tidak Aktif</option>
                  </select>
