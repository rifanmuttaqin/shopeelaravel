...
<div class="col-lg-12 col-md-12 col-12 col-sm-12">
      ...
      <div class="card-body">
            ...
            <form  method="post" action="{{route('customer-offline-store')}}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        <label>Kontak</label>
                        <input type="text" class="form-control form-control-user" name ="no_hp" id="no_hp" placeholder="">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" name ="akun_shopee" id="akun_shopee" placeholder="">
                        <small> Nomor HP </small>
