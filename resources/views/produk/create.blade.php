        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="row text-center">
                              ...
                              <div class="col-sm-12">
                                    <div style="text-align: center; padding-top: 20px">
                                          ...
                                          <button onclick="document.getElementById('image').click();" class="btn">
                  ...
                  <div class="col-8">
                  <form style="padding-top:10px" method="post" action="{{route('produk-store')}}" enctype="multipart/form-data">
                        @csrf
