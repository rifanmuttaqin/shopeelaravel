				...
				<div class="dropdown-list-content dropdown-list-icons">
					...
					<div class="dropdown-item-icon bg-primary text-white">
						<i class="fas fa-code"></i>
							...
							@if($notif_unread->type === config('notification.notification_type.RENEW_CUSTOMER_DATA')) {{'Pembaharuan data customer'}} @endif
							
							<div class="time text-primary"> {{ Carbon\Carbon::parse($notif_unread->created_at)->diffForHumans().' ('.$notif_unread->data['name'].')' }}   </div>
